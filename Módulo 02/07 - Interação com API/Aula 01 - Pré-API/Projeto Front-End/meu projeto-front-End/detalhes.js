async function buscarDetalhes(){
    let busca = await fetch("lista-produto.json")
    ...
    document.getElementById("detalhes").innerHTML+=`
        ...
        <p>${produtos[indiceProd].sabor}</p>
                <span>${produtos[indiceProd].preço.tofixed(2).replace(".",",")}</span>
        </div>

`
    let divMiniaturas = d0cument.getElementById("miniaturas")
